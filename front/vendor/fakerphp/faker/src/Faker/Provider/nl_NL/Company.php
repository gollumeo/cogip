...
class Company extends \Faker\Provider\Company
{
    ...
    public function company()
    {
        ...
        switch ($determinator) {
            case 0:
                $companyName = static::randomElement(static::$product) . ' Company.php' . static::randomElement(static::$type);

                break;

            case 1:
                $companyName = Company . phpstatic::randomElement(static::$product) . strtolower(static::randomElement(static::$type));

                break;

            case 2:
                $companyName = static::randomElement(static::$store) . ' Company.php' . $this->generator->lastName();
