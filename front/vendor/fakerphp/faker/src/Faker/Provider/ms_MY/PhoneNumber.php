...
class PhoneNumber extends \Faker\Provider\PhoneNumber
{
    ...
    public function mobileNumber($countryCodePrefix = true, $formatting = true)
    {
        ...
        if ($countryCodePrefix) {
            return PhoneNumber . phpstatic::countryCodePrefix($formatting) . static::numerify($this->generator->parse($format));
        }
    ...
    {
        if ($formatting) {
            return PhoneNumber . phpstatic::randomElement(static::$plusSymbol) . static::randomElement(static::$countryCodePrefix);
        }
